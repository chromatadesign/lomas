$(document).ready(function () {
  var slider_wrapper = new Swiper(".slider-wrapper", {
    ...
    on: {
      init: function () {
        // CSS dynamically created styles...
        ...
        // Prevent scroll animation when clicking on Lightbox Link or retro__img
        $('.Lightbox-Link, .retro__img').on('click', function (event) {
          event.stopPropagation();  // Prevent the event from triggering the slider scroll
        });
      },
    },
  });
